...
namespace Flowthru.Spark.Utils
{
  ...
  internal static class DataFrameUdfUtils
  {
    ...
    internal static Delegate CreateVectorUdfWrapper<T1, T2, T3, T4, TResult>(
      ...
      where TResult : DataFrameColumn
    {
      return (DataFrameDelegate)new DataFrameUdfWrapper<T1, T2, T3, T4, TResult>(udf).Execute;
    }
    ...
    internal static Delegate CreateVectorUdfWrapper<T1, T2, T3, T4, T5, TResult>(
      ...
      where TResult : DataFrameColumn
    {
      return (DataFrameDelegate)new DataFrameUdfWrapper<T1, T2, T3, T4, T5, TResult>(udf).Execute;
    }
      ...
      where TResult : DataFrameColumn
    {
      return (DataFrameDelegate)
        new DataFrameUdfWrapper<T1, T2, T3, T4, T5, T6, TResult>(udf).Execute;
    }
    ...
    {
      return (DataFrameDelegate)
        new DataFrameUdfWrapper<T1, T2, T3, T4, T5, T6, T7, TResult>(udf).Execute;
    }
    ...
    {
      return (DataFrameDelegate)
        new DataFrameUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(udf).Execute;
    }
    ...
    {
      return (DataFrameDelegate)
        new DataFrameUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(udf).Execute;
    }
    ...
    {
      return (DataFrameDelegate)
        new DataFrameUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(udf).Execute;
    }
  }
}
