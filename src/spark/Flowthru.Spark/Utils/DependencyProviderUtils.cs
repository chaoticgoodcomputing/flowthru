...
namespace Flowthru.Spark.Utils
{
  internal class DependencyProviderUtils
  {
    ...
    internal class NuGetMetadata
    {
      ...
      {
        return (obj is NuGetMetadata nugetMetadata) && Equals(nugetMetadata);
      }
    ...
    internal class Metadata
    {
      ...
      public override bool Equals(object obj)
      {
        return (obj is Metadata metadata) && Equals(metadata);
      }
      ...
      {
        return (other != null)
          && CollectionUtils.ArrayEquals(AssemblyProbingPaths, other.AssemblyProbingPaths)
