...
namespace Flowthru.Spark.Utils
{
  ...
  internal class UdfSerDe
  {
    ...
    internal sealed class TypeData : IEquatable<TypeData>
    {
      ...
      {
        return (obj is TypeData typeData) && Equals(typeData);
      }
    ...
    internal sealed class UdfData
    {
      ...
      public override bool Equals(object obj)
      {
        return (obj is UdfData udfData) && Equals(udfData);
      }
    ...
    internal sealed class TargetData
    {
      ...
      public override bool Equals(object obj)
      {
        return (obj is TargetData targetData) && Equals(targetData);
      }
    ...
    internal sealed class FieldData
    {
      ...
      public override bool Equals(object obj)
      {
        return (obj is FieldData fieldData) && Equals(fieldData);
      }
    ...
    private static TargetData SerializeTarget(object target)
    {
      ...
      bool doesUdfHaveClosure =
        fields.Where((field) => field.TypeData.Name.Equals(targetTypeData.Name)).Count() == 0;
    ...
    private static Type DeserializeType(TypeData typeData) =>
      s_typeCache.GetOrAdd(
        ...
        td =>
        {
          Type type = AssemblyLoader
            .LoadAssembly(td.AssemblyName, td.AssemblyFileName)
            ?.GetType(td.Name, true);
          if (type == null)
          {
