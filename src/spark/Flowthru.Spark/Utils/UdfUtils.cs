...
namespace Flowthru.Spark.Utils
{
  ...
  internal static class UdfUtils
  {
    ...
    /// </summary>
    private static readonly Dictionary<Type, string> s_returnTypes = new Dictionary<Type, string>
    {
    ...
    internal static Delegate CreateUdfWrapper<T1, T2, T3, TResult>(Func<T1, T2, T3, TResult> udf)
    {
    ...
    {
      return (PicklingDelegate)new PicklingUdfWrapper<T1, T2, T3, T4, TResult>(udf).Execute;
    }
    ...
    {
      return (PicklingDelegate)new PicklingUdfWrapper<T1, T2, T3, T4, T5, TResult>(udf).Execute;
    }
    ...
    {
      return (PicklingDelegate)new PicklingUdfWrapper<T1, T2, T3, T4, T5, T6, TResult>(udf).Execute;
    }
    ...
    {
      return (PicklingDelegate)
        new PicklingUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(udf).Execute;
    }
    ...
    {
      return (PicklingDelegate)
        new PicklingUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(udf).Execute;
    }
    ...
    internal static Delegate CreateVectorUdfWrapper<T1, T2, T3, T4, T5, TResult>(
      ...
      where TResult : IArrowArray
    {
      return (ArrowDelegate)new ArrowUdfWrapper<T1, T2, T3, T4, T5, TResult>(udf).Execute;
    }
    ...
    internal static Delegate CreateVectorUdfWrapper<T1, T2, T3, T4, T5, T6, TResult>(
      ...
      where TResult : IArrowArray
    {
      return (ArrowDelegate)new ArrowUdfWrapper<T1, T2, T3, T4, T5, T6, TResult>(udf).Execute;
    }
    ...
    internal static Delegate CreateVectorUdfWrapper<T1, T2, T3, T4, T5, T6, T7, TResult>(
      ...
      where TResult : IArrowArray
    {
      return (ArrowDelegate)new ArrowUdfWrapper<T1, T2, T3, T4, T5, T6, T7, TResult>(udf).Execute;
    }
    ...
    {
      return (ArrowDelegate)
        new ArrowUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(udf).Execute;
    }

    internal static Delegate CreateVectorUdfWrapper<
      T1,
      T2,
      T3,
      T4,
    ...
    {
      return (ArrowDelegate)
        new ArrowUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(udf).Execute;
    }
  }
}
