...
namespace Flowthru.Spark.Interop.Internal.Java.Util
{
  ...
  internal sealed class HashMap : IJvmObjectReferenceProvider
  {
    ...
    internal HashMap(IJvmBridge jvm) => Reference = jvm.CallConstructor("java.util.HashMap");
    ...
    internal object Get(object key) => Reference.Invoke("get", key);
    ...
    internal bool ContainsValue(object value) => (bool)Reference.Invoke("containsValue", value);
