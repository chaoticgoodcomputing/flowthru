...
namespace Flowthru.Spark.Interop.Ipc
{
  ...
  internal sealed class JvmObjectId
  {
    ...
    public override bool Equals(object obj) =>
      ReferenceEquals(this, obj) || ((obj is JvmObjectId jvmObjectId) && Id.Equals(jvmObjectId.Id));
  ...
  public sealed class JvmObjectReference : IJvmObjectReferenceProvider
  {
    ...
    public override bool Equals(object obj)
    {
      ...
      return (obj is IJvmObjectReferenceProvider provider) && Id.Equals(provider.Reference.Id);
    }
