...
namespace Flowthru.Spark.Interop.Ipc
{
  ...
  internal class SerDe
  {
    ...
    public static bool ReadBool(Stream s) => Convert.ToBoolean(s.ReadByte());
    ...
    public static void Write(Stream s, byte value) => s.WriteByte(value);
    ...
    public static void Write(Stream s, byte[] value) => Write(s, value, value.Length);
    ...
    public static void Write(Stream s, byte[] value, int count) => s.Write(value, 0, count);
    ...
    public static void Write(Stream s, bool value) => Write(s, Convert.ToByte(value));
