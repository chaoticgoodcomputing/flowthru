...
namespace Flowthru.Spark.Interop.Ipc
{
  ...
  public interface IJvmBridge : IDisposable
  {
    ...
    /// support and should be used with caution.
    /// </remarks>
    JvmObjectReference CallConstructor(string className, object arg0);
    ...
    /// support and should be used with caution.
    /// </remarks>
    JvmObjectReference CallConstructor(string className, object arg0, object arg1);
    ...
    /// support and should be used with caution.
    /// </remarks>
    JvmObjectReference CallConstructor(string className, params object[] args);
    ...
    /// support and should be used with caution.
    /// </remarks>
    object CallStaticJavaMethod(string className, string methodName, object arg0);
    ...
    /// support and should be used with caution.
    /// </remarks>
    object CallStaticJavaMethod(string className, string methodName, object arg0, object arg1);
    ...
    /// support and should be used with caution.
    /// </remarks>
    object CallStaticJavaMethod(string className, string methodName, params object[] args);
    ...
    /// support and should be used with caution.
    /// </remarks>
    object CallNonStaticJavaMethod(JvmObjectReference jvmObject, string methodName, object arg0);
