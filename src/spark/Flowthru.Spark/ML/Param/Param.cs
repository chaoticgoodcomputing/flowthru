...
namespace Flowthru.Spark.ML.Feature.Param
{
  ...
  {
    private static readonly string s_ParamClassName = "org.apache.spark.ml.param.Param";
    ...
    public Param(Identifiable parent, string name, string doc)
      : this(SparkEnvironment.JvmBridge.CallConstructor(s_ParamClassName, parent.Uid(), name, doc))
    { }
