...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// </summary>
  public class Pipeline : JavaEstimator<PipelineModel>, IJavaMLWritable, IJavaMLReadable<Pipeline>
  {
    ...
    public static Pipeline Load(string path) =>
      WrapAsPipeline(SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_className, "load", path));
    ...
    private static Pipeline WrapAsPipeline(object obj) => new Pipeline((JvmObjectReference)obj);
  }
}
