...
{
  public class Word2Vec : JavaEstimator<Word2VecModel>, IJavaMLWritable, IJavaMLReadable<Word2Vec>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.Word2Vec";
    ...
    /// <returns><see cref="Word2Vec"/></returns>
    public Word2Vec SetMaxIter(int value) => WrapAsWord2Vec(Reference.Invoke("setMaxIter", value));
    ...
    public virtual int GetMaxSentenceLength() => (int)Reference.Invoke("getMaxSentenceLength");
    ...
    /// <returns><see cref="Word2Vec"/></returns>
    public Word2Vec SetSeed(long value) => WrapAsWord2Vec(Reference.Invoke("setSeed", value));
    ...
    public static Word2Vec Load(string path) =>
      WrapAsWord2Vec(SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_className, "load", path));
    ...
    public JavaMLWriter Write() => new JavaMLWriter((JvmObjectReference)Reference.Invoke("write"));
    ...
    private static Word2Vec WrapAsWord2Vec(object obj) => new Word2Vec((JvmObjectReference)obj);
  }
}
