...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// </summary>
  public class Bucketizer : JavaModel<Bucketizer>, IJavaMLWritable, IJavaMLReadable<Bucketizer>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.Bucketizer";
    ...
    public static Bucketizer Load(string path) =>
      WrapAsBucketizer(SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_className, "load", path));
