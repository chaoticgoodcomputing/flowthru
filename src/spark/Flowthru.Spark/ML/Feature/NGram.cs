...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// </summary>
  public class NGram : JavaTransformer, IJavaMLWritable, IJavaMLReadable<NGram>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.NGram";
    ...
    public static NGram Load(string path) =>
      WrapAsNGram(SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_className, "load", path));
