...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// white spaces.
  /// </summary>
  public class IDFModel : JavaModel<IDFModel>, IJavaMLWritable, IJavaMLReadable<IDFModel>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.IDFModel";
    ...
    private static IDFModel WrapAsIDFModel(object obj) => new IDFModel((JvmObjectReference)obj);
  }
}
