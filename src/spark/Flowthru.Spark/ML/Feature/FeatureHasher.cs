...
{
  public class FeatureHasher : JavaTransformer, IJavaMLWritable, IJavaMLReadable<FeatureHasher>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.FeatureHasher";
