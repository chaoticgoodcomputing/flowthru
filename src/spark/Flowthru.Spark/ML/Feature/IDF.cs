...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// </summary>
  public class IDF : JavaEstimator<IDFModel>, IJavaMLWritable, IJavaMLReadable<IDF>
  {
    ...
    /// <returns>New <see cref="IDF"/> object</returns>
    public IDF SetOutputCol(string value) => WrapAsIDF(Reference.Invoke("setOutputCol", value));
    ...
    /// <returns>New <see cref="IDF"/> object</returns>
    public IDF SetMinDocFreq(int value) => WrapAsIDF(Reference.Invoke("setMinDocFreq", value));
    ...
    {
      return WrapAsIDF(SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_className, "load", path));
    }
