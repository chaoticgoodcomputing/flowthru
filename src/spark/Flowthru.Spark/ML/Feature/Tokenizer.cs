...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// white spaces.
  /// </summary>
  public class Tokenizer : JavaTransformer, IJavaMLWritable, IJavaMLReadable<Tokenizer>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.Tokenizer";
    ...
    private static Tokenizer WrapAsTokenizer(object obj) => new Tokenizer((JvmObjectReference)obj);
  }
}
