...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// </summary>
  public class SQLTransformer : JavaTransformer, IJavaMLWritable, IJavaMLReadable<SQLTransformer>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.SQLTransformer";
