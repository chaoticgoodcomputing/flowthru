...
namespace Flowthru.Spark.ML.Feature
{
  ...
  /// to the columns.
  /// </summary>
  public class HashingTF : JavaTransformer, IJavaMLWritable, IJavaMLReadable<HashingTF>
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.HashingTF";
    ...
    public static HashingTF Load(string path) =>
      WrapAsHashingTF(SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_className, "load", path));
    ...
    public HashingTF SetBinary(bool value) => WrapAsHashingTF(Reference.Invoke("setBinary", value));
    ...
    private static HashingTF WrapAsHashingTF(object obj) => new HashingTF((JvmObjectReference)obj);
  }
}
