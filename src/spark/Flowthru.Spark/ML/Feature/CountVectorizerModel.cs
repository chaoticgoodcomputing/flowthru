...
namespace Flowthru.Spark.ML.Feature
{
  ...
  {
    private static readonly string s_className = "org.apache.spark.ml.feature.CountVectorizerModel";
    ...
    public CountVectorizerModel(List<string> vocabulary)
      : this(SparkEnvironment.JvmBridge.CallConstructor(s_className, vocabulary)) { }
    ...
    public CountVectorizerModel(string uid, List<string> vocabulary)
      : this(SparkEnvironment.JvmBridge.CallConstructor(s_className, uid, vocabulary)) { }
    ...
    public override StructType TransformSchema(StructType value) =>
      new StructType(
        (JvmObjectReference)
          Reference.Invoke("transformSchema", DataType.FromJson(Reference.Jvm, value.Json))
      );
