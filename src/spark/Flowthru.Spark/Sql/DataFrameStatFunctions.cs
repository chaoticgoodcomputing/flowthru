...
namespace Flowthru.Spark.Sql
{
  ...
  public sealed class DataFrameStatFunctions : IJvmObjectReferenceProvider
  {
    ...
    ) => (double[])Reference.Invoke("approxQuantile", columnName, probabilities, relativeError);
    ...
    /// <returns>DataFrame object</returns>
    public DataFrame SampleBy<T>(string columnName, IDictionary<T, double> fractions, long seed) =>
