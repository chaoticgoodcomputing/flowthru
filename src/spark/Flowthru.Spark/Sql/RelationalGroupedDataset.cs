...
namespace Flowthru.Spark.Sql
{
  ...
  public sealed class RelationalGroupedDataset : IJvmObjectReferenceProvider
  {
    ...
    public DataFrame Count() => new DataFrame((JvmObjectReference)Reference.Invoke("count"));
    ...
    public RelationalGroupedDataset Pivot(string pivotColumn) =>
      new RelationalGroupedDataset(
        (JvmObjectReference)Reference.Invoke("pivot", pivotColumn),
        _dataFrame
      );
    ...
    public RelationalGroupedDataset Pivot(string pivotColumn, IEnumerable<object> values) =>
      new RelationalGroupedDataset(
        (JvmObjectReference)Reference.Invoke("pivot", pivotColumn, values),
        _dataFrame
      );
    ...
    {
      DataFrameGroupedMapWorkerFunction.ExecuteDelegate wrapper = new DataFrameGroupedMapUdfWrapper(
        func
      ).Execute;
      ...
      return new DataFrame(
        (JvmObjectReference)Reference.Invoke("flatMapGroupsInPandas", udfColumn.Expr())
      );
    }
    ...
    {
      ArrowGroupedMapWorkerFunction.ExecuteDelegate wrapper = new ArrowGroupedMapUdfWrapper(
        func
      ).Execute;
