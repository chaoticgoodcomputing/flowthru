  ...
  public sealed class StorageLevel : IJvmObjectReferenceProvider
  {
    ...
    public static StorageLevel NONE =>
      s_none ??= new StorageLevel(
        (JvmObjectReference)
          SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_storageLevelClassName, "NONE")
      );
    ...
    public static StorageLevel DISK_ONLY =>
      s_diskOnly ??= new StorageLevel(
        (JvmObjectReference)
          SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_storageLevelClassName, "DISK_ONLY")
      );
    ...
    public static StorageLevel DISK_ONLY_2 =>
      s_diskOnly2 ??= new StorageLevel(
        (JvmObjectReference)
          SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_storageLevelClassName, "DISK_ONLY_2")
      );
    ...
    public static StorageLevel MEMORY_ONLY =>
      s_memoryOnly ??= new StorageLevel(
        (JvmObjectReference)
          SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_storageLevelClassName, "MEMORY_ONLY")
      );
    ...
    public static StorageLevel MEMORY_ONLY_2 =>
      s_memoryOnly2 ??= new StorageLevel(
        (JvmObjectReference)
          SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_storageLevelClassName, "MEMORY_ONLY_2")
      );
    ...
    public static StorageLevel OFF_HEAP =>
      s_offHeap ??= new StorageLevel(
        (JvmObjectReference)
          SparkEnvironment.JvmBridge.CallStaticJavaMethod(s_storageLevelClassName, "OFF_HEAP")
      );
    ...
    public override bool Equals(object obj)
    {
      ...
      return (UseDisk == that.UseDisk)
        && (UseMemory == that.UseMemory)
        && (UseOffHeap == that.UseOffHeap)
        && (Deserialized == that.Deserialized)
