...
namespace Flowthru.Spark.Sql.Catalog
{
  ...
  public sealed class Catalog : IJvmObjectReferenceProvider
  {
    ...
    public DataFrame CreateTable(string tableName, string path, string source) =>
      new DataFrame((JvmObjectReference)Reference.Invoke("createTable", tableName, path, source));
    ...
    public DataFrame CreateTable(
      ...
      new DataFrame(
        (JvmObjectReference)Reference.Invoke("createTable", tableName, source, options)
      );
    ...
    public DataFrame CreateTable(
      ...
      new DataFrame(
        (JvmObjectReference)Reference.Invoke("createTable", tableName, source, description, options)
      );
    ...
    public bool DatabaseExists(string dbName) => (bool)Reference.Invoke("databaseExists", dbName);
    ...
    /// </param>
    /// <returns>bool, true if the view was dropped and false if it was not dropped.</returns>
    public bool DropTempView(string viewName) => (bool)Reference.Invoke("dropTempView", viewName);
    ...
    public Function GetFunction(string dbName, string functionName) =>
      new Function((JvmObjectReference)Reference.Invoke("getFunction", dbName, functionName));
    ...
    public void SetCurrentDatabase(string dbName) => Reference.Invoke("setCurrentDatabase", dbName);
    ...
    public bool TableExists(string tableName) => (bool)Reference.Invoke("tableExists", tableName);
