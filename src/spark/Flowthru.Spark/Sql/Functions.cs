...
namespace Flowthru.Spark.Sql
{
  ...
  public static class Functions
  {
    ...
    {
      return new Column(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_functionsClassName, "lit", literal)
      );
    }
    ...
    public static DataFrame Broadcast(DataFrame df)
    {
      return new DataFrame(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_functionsClassName, "broadcast", df)
      );
    }
    ...
    /// <returns>Column object</returns>
    public static Column ToJson(Column column, Dictionary<string, string> options = null)
    {
      return ApplyFunction("to_json", column, options ?? new Dictionary<string, string>());
    }
    ...
    {
      return ApplyFunction("from_csv", column, DataType.FromJson(Jvm, schema.Json), options);
    }
    ...
    /// <returns>Column object</returns>
    [Since(Versions.V3_0_0)]
    public static Column FromCsv(Column column, Column schema, Dictionary<string, string> options)
    {
    ...
    /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
    /// </returns>
    public static Func<Column, Column, Column, Column, Column, Column> Udf<
      T1,
      T2,
      T3,
      T4,
    ...
    /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
    /// </returns>
    public static Func<Column, Column, Column, Column, Column, Column, Column> Udf<
      T1,
      T2,
      T3,
      T4,
    ...
    /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
    /// </returns>
    public static Func<Column, Column, Column, Column, Column, Column, Column, Column> Udf<
      T1,
      T2,
      T3,
      T4,
    ...
    /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
    /// </returns>
    public static Func<Column, Column, Column, Column, Column, Column, Column, Column, Column> Udf<
      T1,
      T2,
      T3,
      T4,
    ...
    public static Func<
      ...
      Column,
      Column
    > Udf<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(
    ...
    public static Func<
      ...
      Column,
      Column
    > Udf<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(
    ...
    public static Func<
      ...
      Column,
      Column
    > Udf<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
      Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, Row> udf,
      StructType returnType
    )
    {
    ...
    public static Func<
      ...
      Column,
      Column
    > Udf<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
      Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Row> udf,
      StructType returnType
    )
    {
    ...
    {
      return new Column(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_functionsClassName, funcName)
      );
    }
    ...
    {
      return new Column(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_functionsClassName, funcName, arg)
      );
    }
    ...
    {
      return new Column(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_functionsClassName, funcName, arg1, arg2)
      );
    }
    ...
    {
      return new Column(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_functionsClassName, funcName, args)
      );
    }
  }
}
