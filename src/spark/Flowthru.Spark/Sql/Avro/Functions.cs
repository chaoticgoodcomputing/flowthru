...
namespace Flowthru.Spark.Sql.Avro
{
  ...
  public static class Functions
  {
    ...
    private static readonly Lazy<string> s_avroClassName = new Lazy<string>(() =>
    {
    ...
    public static Column FromAvro(Column data, string jsonFormatSchema) =>
      new Column(
        (JvmObjectReference)
          Jvm.CallStaticJavaMethod(s_avroClassName.Value, "from_avro", data, jsonFormatSchema)
      );
    ...
    public static Column ToAvro(Column data) =>
      new Column(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_avroClassName.Value, "to_avro", data)
      );
    ...
    public static Column ToAvro(Column data, string jsonFormatSchema) =>
      new Column(
        (JvmObjectReference)
          Jvm.CallStaticJavaMethod(s_avroClassName.Value, "to_avro", data, jsonFormatSchema)
      );
  }
}
