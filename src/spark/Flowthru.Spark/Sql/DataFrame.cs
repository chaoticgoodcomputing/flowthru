...
namespace Flowthru.Spark.Sql
{
  ...
  public sealed class DataFrame : IJvmObjectReferenceProvider
  {
    ...
    {
      get { return WrapAsColumn(Reference.Invoke("col", columnName)); }
    }
    ...
    public StructType Schema() => new StructType((JvmObjectReference)Reference.Invoke("schema"));
    ...
    {
      var execution = (JvmObjectReference)Reference.Invoke("queryExecution");
      var explainMode = (JvmObjectReference)
    ...
    public IEnumerable<Tuple<string, string>> DTypes() =>
      Schema().Fields.Select(f => new Tuple<string, string>(f.Name, f.DataType.SimpleString));

    /// <summary>
    /// Returns all column names.
    /// </summary>
    /// <returns>Column names</returns>
    public IReadOnlyList<string> Columns() => Schema().Fields.Select(field => field.Name).ToArray();
    ...
    public DataFrame ToJSON() => WrapAsDataFrame(Reference.Invoke("toJSON"));
    ...
    /// <returns>DataFrame object</returns>
    public DataFrame Join(DataFrame right) => WrapAsDataFrame(Reference.Invoke("join", right));
    ...
    /// <returns>Column object</returns>
    public Column ColRegex(string colName) => WrapAsColumn(Reference.Invoke("colRegex", colName));
    ...
    /// <returns>DataFrame object</returns>
    public DataFrame Union(DataFrame other) => WrapAsDataFrame(Reference.Invoke("union", other));
    ...
    /// <param name="other">Other DataFrame</param>
    /// <returns>DataFrame object</returns>
    public DataFrame Except(DataFrame other) => WrapAsDataFrame(Reference.Invoke("except", other));
    ...
    /// <returns>DataFrame object</returns>
    public DataFrame Sample(double fraction, bool withReplacement = false, long? seed = null) =>
      WrapAsDataFrame(
        seed.HasValue
    ...
    {
      var dataFrames = (JvmObjectReference[])(
        seed.HasValue
    ...
    {
      (int port, string secret, JvmObjectReference server) = ParseConnectionInfo(
    ...
    public DataFrame RepartitionByRange(int numPartitions, params Column[] partitionExprs)
    {
      ...
      return WrapAsDataFrame(Reference.Invoke("repartitionByRange", numPartitions, partitionExprs));
    }
    ...
    /// </returns>
    [Since(Versions.V3_1_0)]
    public bool SameSemantics(DataFrame other) => (bool)Reference.Invoke("sameSemantics", other);
    ...
    [Since(Versions.V3_1_0)]
    public int SemanticHash() => (int)Reference.Invoke("semanticHash");
    ...
    private (int, string, JvmObjectReference) ParseConnectionInfo(object info, bool parseServer)
    {
      var infos = (JvmObjectReference[])info;
      return (
        (int)infos[0].Invoke("intValue"),
