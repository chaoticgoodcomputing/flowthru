...
namespace Flowthru.Spark.Sql.Expressions
{
  ...
  public static class Window
  {
    ...
    private static readonly string s_windowClassName = "org.apache.spark.sql.expressions.Window";
    ...
    /// <param name="columns">Column expressions</param>
    /// <returns>WindowSpec object</returns>
    public static WindowSpec OrderBy(params Column[] columns) => Apply("orderBy", (object)columns);
    ...
    /// </param>
    /// <returns>WindowSpec object</returns>
    public static WindowSpec RowsBetween(long start, long end) => Apply("rowsBetween", start, end);
    ...
    private static WindowSpec Apply(string methodName, object arg)
    {
      return new WindowSpec(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_windowClassName, methodName, arg)
      );
    }
    ...
    {
      return new WindowSpec(
        (JvmObjectReference)Jvm.CallStaticJavaMethod(s_windowClassName, methodName, arg1, arg2)
      );
    }
  }
}
