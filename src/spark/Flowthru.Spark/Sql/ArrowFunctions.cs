...
namespace Flowthru.Spark.Sql
{
  ...
  public static class ArrowFunctions
  {
    ...
    {
      return Functions
        .CreateVectorUdf<TResult>(udf.Method.ToString(), UdfUtils.CreateVectorUdfWrapper(udf))
        .Apply1;
    }
    ...
    /// A delegate that returns a <see cref="Column"/> for the result of the Vector UDF.
    /// </returns>
    public static Func<Column, Column, Column, Column, Column, Column> VectorUdf<
      T1,
      T2,
      T3,
      T4,
    ...
    /// A delegate that returns a <see cref="Column"/> for the result of the Vector UDF.
    /// </returns>
    public static Func<Column, Column, Column, Column, Column, Column, Column> VectorUdf<
      T1,
      T2,
      T3,
      T4,
    ...
    /// A delegate that returns a <see cref="Column"/> for the result of the Vector UDF.
    /// </returns>
    public static Func<Column, Column, Column, Column, Column, Column, Column, Column> VectorUdf<
      T1,
      T2,
      T3,
      T4,
    ...
    public static Func<
      ...
      Column,
      Column
    > VectorUdf<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(
    ...
    public static Func<
      ...
      Column,
      Column
    > VectorUdf<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(
    ...
    public static Func<
      ...
      Column,
      Column
    > VectorUdf<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(
