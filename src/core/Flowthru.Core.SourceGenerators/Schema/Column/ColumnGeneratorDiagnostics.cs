...
internal static class ColumnGeneratorDiagnostics
{
  ...
  /// <summary>
  /// FT1003: The backing type provided to <c>[FlowthruColumn]</c> is not a
  ...
  /// All uses of <c>[FlowthruColumn]</c> with the same property type must
  /// agree on a single backing type.
  /// </summary>
