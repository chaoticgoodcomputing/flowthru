...
/// <summary>
/// Resolves and probes <see cref="ServiceRef.External"/> values without
/// Core knowing the concrete extension. The host registers one
/// dispatcher per <see cref="IExtensionServiceRef.Category"/>; the
...
/// incoming <see cref="IExtensionServiceRef"/>.
/// </para>
/// </remarks>
public interface IServiceRefDispatcher
{
  /// <summary>
  /// The <see cref="IExtensionServiceRef.Category"/> this dispatcher
  ...
  /// </summary>
  FlowIO<Validated<PreFlightError, FlowUnit>> Inspect(IExtensionServiceRef serviceRef);
}
