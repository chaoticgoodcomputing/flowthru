...
/// metadata for Flowthru.Core.Viz. The inferred schema includes property names, types,
...
internal static class SchemaInference
{
    ...
    public static SchemaMetadata? InferSchema(Type type)
    {
        ...
        try
        {
            ...
            return new SchemaMetadata { Fields = fields };
        }
        catch
        {
    ...
    private static bool IsNullable(PropertyInfo property)
    {
        ...
        var nullableAttribute = property.CustomAttributes.FirstOrDefault(attr =>
          attr.AttributeType.Name == "NullableAttribute"
        );
        ...
        if (nullableAttribute != null)
        {
            ...
            if (nullableAttribute.ConstructorArguments.Count > 0)
            {
                ...
                if (
                  flagValue
                    is System.Collections.ObjectModel.ReadOnlyCollection<CustomAttributeTypedArgument> array
                  && array.Count > 0
