...
public class StepMetadata
{
    ...
    /// <summary>
    /// Number of <c>[StepTest]</c> methods registered against this step's type.
    /// Only populated when <c>Flowthru.FUnit</c> is referenced and the
    /// <c>StepTestRegistry</c> is present in the loaded assemblies.
    /// <c>null</c> when FUnit is absent.
    /// </summary>
