...
Flowthru.ML.Next provides a thin, principled facade over ML.NET's data transformation capabilities using LanguageExt v5's type system and monadic error handling. The library emphasizes:
