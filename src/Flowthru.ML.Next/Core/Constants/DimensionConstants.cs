namespace Flowthru.ML.Next.Core.Constants;
...
/// </remarks>
public abstract class Constant<T> where T : struct {
  /// <summary>
  /// The constant value.
  /// </summary>
  public T Value { get; }
