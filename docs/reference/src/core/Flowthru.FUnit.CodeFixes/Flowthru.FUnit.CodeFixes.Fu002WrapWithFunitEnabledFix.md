# <a id="Flowthru_FUnit_CodeFixes_Fu002WrapWithFunitEnabledFix"></a> Class Fu002WrapWithFunitEnabledFix
...
```csharp
[ExportCodeFixProvider("C#", new string[] { }, Name = "Fu002WrapWithFunitEnabledFix")]
[Shared]
...
### <a id="Flowthru_FUnit_CodeFixes_Fu002WrapWithFunitEnabledFix_FixableDiagnosticIds"></a> FixableDiagnosticIds
...
### <a id="Flowthru_FUnit_CodeFixes_Fu002WrapWithFunitEnabledFix_GetFixAllProvider"></a> GetFixAllProvider\(\)
...
### <a id="Flowthru_FUnit_CodeFixes_Fu002WrapWithFunitEnabledFix_RegisterCodeFixesAsync_Microsoft_CodeAnalysis_CodeFixes_CodeFixContext_"></a> RegisterCodeFixesAsync\(CodeFixContext\)
