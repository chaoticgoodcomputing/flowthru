# <a id="Flowthru_Core_Configuration_ICatalogFactory"></a> Interface ICatalogFactory
...
### <a id="Flowthru_Core_Configuration_ICatalogFactory_CreateCatalog_Flowthru_Core_Configuration_CatalogOptions_System_IServiceProvider_"></a> CreateCatalog\(CatalogOptions, IServiceProvider\)
...
`options` [CatalogOptions](Flowthru.Core.Configuration.CatalogOptions.md)
