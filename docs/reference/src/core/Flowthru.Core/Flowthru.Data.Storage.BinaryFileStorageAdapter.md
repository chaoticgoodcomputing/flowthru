# <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter"></a> Class BinaryFileStorageAdapter
...
[IStorageAdapter<byte\[\]\>](Flowthru.Data.Storage.IStorageAdapter\-1.md)
...
### <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter__ctor_System_String_"></a> BinaryFileStorageAdapter\(string\)
...
### <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter_Traits"></a> Traits
...
### <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter_Load"></a> Load\(\)
...
#### Returns
 ...
 [FlowIO](Flowthru.Effects.FlowIO\-1.md)<[byte](https://learn.microsoft.com/dotnet/api/system.byte)\[\]\>
...
### <a id="Flowthru_Data_Storage_BinaryFileStorageAdapter_Save_System_Byte___"></a> Save\(byte\[\]\)
