# <a id="Flowthru_Meta_FlowthruMetadataConfiguration"></a> Class FlowthruMetadataConfiguration
...
[FlowthruMetadataConfiguration](Flowthru.Meta.FlowthruMetadataConfiguration.md)
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_AutoExportDag"></a> AutoExportDag
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_ExportMermaid"></a> ExportMermaid
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_OutputDirectory"></a> OutputDirectory
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_DisableAutoExport"></a> DisableAutoExport\(\)
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_DisableMermaid"></a> DisableMermaid\(\)
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_EnableAutoExport"></a> EnableAutoExport\(\)
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_EnableMermaid"></a> EnableMermaid\(\)
...
### <a id="Flowthru_Meta_FlowthruMetadataConfiguration_WithOutputDirectory_System_String_"></a> WithOutputDirectory\(string\)
