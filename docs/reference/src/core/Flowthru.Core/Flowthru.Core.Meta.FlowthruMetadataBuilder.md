# <a id="Flowthru_Core_Meta_FlowthruMetadataBuilder"></a> Class FlowthruMetadataBuilder
...
### <a id="Flowthru_Core_Meta_FlowthruMetadataBuilder_AddProvider__2_System_Action___1__"></a> AddProvider<TProvider, TBuilder\>\(Action<TBuilder\>?\)
...
The metadata provider type (must implement <xref href="Flowthru.Core.Meta.Providers.IMetadataProvider" data-throw-if-not-resolved="false"></xref> and have <xref href="Flowthru.Core.Meta.MetadataProviderBuilderAttribute" data-throw-if-not-resolved="false"></xref>)
...
Thrown when provider type lacks <xref href="Flowthru.Core.Meta.MetadataProviderBuilderAttribute" data-throw-if-not-resolved="false"></xref> or builder type mismatch

### <a id="Flowthru_Core_Meta_FlowthruMetadataBuilder_AddProvider_Flowthru_Core_Meta_Providers_IMetadataProvider_"></a> AddProvider\(IMetadataProvider\)
...
`provider` [IMetadataProvider](Flowthru.Core.Meta.Providers.IMetadataProvider.md)
