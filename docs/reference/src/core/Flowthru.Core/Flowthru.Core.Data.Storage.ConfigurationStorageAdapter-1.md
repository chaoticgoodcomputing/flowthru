# <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1"></a> Class ConfigurationStorageAdapter<T\>
...
```csharp
public sealed class ConfigurationStorageAdapter<T> : IStorageAdapter<T> where T : class, new()
```
...
IConfiguration.Get&lt;T&gt; can materialize it.
...
<ul><li>Missing section detected during pre-flight (<xref href="Flowthru.Core.Data.Storage.ConfigurationStorageAdapter%601.InspectShallow(System.Int32)" data-throw-if-not-resolved="false"></xref>).</li><li>Binding/validation failures detected during pre-flight, not at step execution.</li><li>Type mismatches between step input and config POCO are caught at compile time via
    the <xref href="Flowthru.Core.Data.Storage.IStorageAdapter%601" data-throw-if-not-resolved="false"></xref> generic parameter.</li></ul>
<p>
<strong>Storage traits:</strong> read-only, non-persistent. <xref href="Flowthru.Core.Data.Storage.ConfigurationStorageAdapter%601.Save(%600)" data-throw-if-not-resolved="false"></xref> always
throws <xref href="System.NotSupportedException" data-throw-if-not-resolved="false"></xref>.
</p>

## Constructors

### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1__ctor_System_String_Microsoft_Extensions_Configuration_IConfiguration_"></a> ConfigurationStorageAdapter\(string, IConfiguration\)

Initializes a new instance of <xref href="Flowthru.Core.Data.Storage.ConfigurationStorageAdapter%601" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1_Traits"></a> Traits
...
### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1_InspectTarget"></a> InspectTarget\(\)
...
### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1_Load"></a> Load\(\)
...
### <a id="Flowthru_Core_Data_Storage_ConfigurationStorageAdapter_1_Save__0_"></a> Save\(T\)
