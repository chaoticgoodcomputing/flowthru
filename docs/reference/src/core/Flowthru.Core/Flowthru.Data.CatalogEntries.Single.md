...
<ul><li>Model files (ML models, configuration objects)</li><li>Metrics and evaluation results (single JSON objects)</li><li>Text reports (Markdown, plain text)</li><li>Binary files (images, PDFs)</li><li>Side-effect-only nodes (null/void semantics)</li></ul>
