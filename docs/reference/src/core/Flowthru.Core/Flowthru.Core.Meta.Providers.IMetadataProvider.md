# <a id="Flowthru_Core_Meta_Providers_IMetadataProvider"></a> Interface IMetadataProvider
...
### <a id="Flowthru_Core_Meta_Providers_IMetadataProvider_Name"></a> Name
...
### <a id="Flowthru_Core_Meta_Providers_IMetadataProvider_Consume_Flowthru_Core_Graph_Meta_Models_DagMetadata_"></a> Consume\(DagMetadata\)
