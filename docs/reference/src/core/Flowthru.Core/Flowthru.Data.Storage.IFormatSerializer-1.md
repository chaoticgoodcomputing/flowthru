# <a id="Flowthru_Data_Storage_IFormatSerializer_1"></a> Interface IFormatSerializer<TRow\>
...
- Storage location (file vs memory) - handled by <xref href="Flowthru.Data.Storage.IStorageMedium" data-throw-if-not-resolved="false"></xref>
- Container type (IEnumerable vs IDataView) - handled by <xref href="Flowthru.Data.Storage.IContainerAdapter%602" data-throw-if-not-resolved="false"></xref>
</p>
<p>
...
<xref href="Flowthru.Data.Storage.SchemaActivator" data-throw-if-not-resolved="false"></xref> or equivalent techniques to instantiate schemas.
</p>
<p>
...
### <a id="Flowthru_Data_Storage_IFormatSerializer_1_Traits"></a> Traits
...
### <a id="Flowthru_Data_Storage_IFormatSerializer_1_DeserializeRows_System_IO_Stream_"></a> DeserializeRows\(Stream\)
...
### <a id="Flowthru_Data_Storage_IFormatSerializer_1_GetPropertyMappingConfiguration"></a> GetPropertyMappingConfiguration\(\)
...
### <a id="Flowthru_Data_Storage_IFormatSerializer_1_SerializeRows_System_IO_Stream_System_Collections_Generic_IAsyncEnumerable__0__"></a> SerializeRows\(Stream, IAsyncEnumerable<TRow\>\)
