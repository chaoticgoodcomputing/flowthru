# <a id="Flowthru_Core_Graph_Validation_IFlowValidationHook"></a> Interface IFlowValidationHook
...
### <a id="Flowthru_Core_Graph_Validation_IFlowValidationHook_ValidateAsync_Flowthru_Core_Flows_Flow_System_Threading_CancellationToken_"></a> ValidateAsync\(Flow, CancellationToken\)
...
`flow` [Flow](Flowthru.Core.Flows.Flow.md)
