# <a id="Flowthru_Flows_Validation_ValidationOptions"></a> Class ValidationOptions
...
### <a id="Flowthru_Flows_Validation_ValidationOptions_Default"></a> Default\(\)
...
### <a id="Flowthru_Flows_Validation_ValidationOptions_Inspect_Flowthru_Data_IItem_Flowthru_Data_Validation_InspectionLevel_"></a> Inspect\(IItem, InspectionLevel\)
