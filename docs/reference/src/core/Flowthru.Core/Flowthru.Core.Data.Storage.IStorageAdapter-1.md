# <a id="Flowthru_Core_Data_Storage_IStorageAdapter_1"></a> Interface IStorageAdapter<T\>
...
<ul><li><strong>Composed:</strong> <xref href="Flowthru.Core.Data.Storage.ComposedStorageAdapter%602" data-throw-if-not-resolved="false"></xref> - composition of medium + format + container</li><li><strong>Custom:</strong> User-defined implementations (database, API, etc.)</li></ul>
<p>
...
<p>
<xref href="Flowthru.Core.Data.IItem%601" data-throw-if-not-resolved="false"></xref> delegates to this interface:
</p>
...
### <a id="Flowthru_Core_Data_Storage_IStorageAdapter_1_Traits"></a> Traits
...
### <a id="Flowthru_Core_Data_Storage_IStorageAdapter_1_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Core_Data_Storage_IStorageAdapter_1_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Core_Data_Storage_IStorageAdapter_1_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Core_Data_Storage_IStorageAdapter_1_Save__0_"></a> Save\(T\)
