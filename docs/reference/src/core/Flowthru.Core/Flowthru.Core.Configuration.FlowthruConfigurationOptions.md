# <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions"></a> Class FlowthruConfigurationOptions
...
[FlowthruConfigurationOptions](Flowthru.Core.Configuration.FlowthruConfigurationOptions.md)
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_ConfigurationFileName"></a> ConfigurationFileName
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_ConfigurationPath"></a> ConfigurationPath
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_EnableYamlSupport"></a> EnableYamlSupport
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_Environment"></a> Environment
...
<ol><li>Value passed to <code>WithEnvironment()</code></li><li>Environment variable specified by <xref href="Flowthru.Core.Configuration.FlowthruConfigurationOptions.EnvironmentVariable" data-throw-if-not-resolved="false"></xref></li><li><code>DOTNET_ENVIRONMENT</code> environment variable</li><li><code>ASPNETCORE_ENVIRONMENT</code> environment variable</li><li>"Production" (default)</li></ol>

### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_EnvironmentVariable"></a> EnvironmentVariable
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_WithConfigurationFileName_System_String_"></a> WithConfigurationFileName\(string\)
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_WithConfigurationPath_System_String_"></a> WithConfigurationPath\(string\)
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_WithEnvironment_System_String_"></a> WithEnvironment\(string\)
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_WithEnvironmentVariable_System_String_"></a> WithEnvironmentVariable\(string?\)
...
### <a id="Flowthru_Core_Configuration_FlowthruConfigurationOptions_WithYamlSupport_System_Boolean_"></a> WithYamlSupport\(bool\)
