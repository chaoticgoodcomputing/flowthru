# <a id="Flowthru_Core_Steps_Factory_TypeActivator"></a> Class TypeActivator

Namespace: [Flowthru.Core.Steps.Factory](Flowthru.Core.Steps.Factory.md)  
...
[TypeActivator](Flowthru.Core.Steps.Factory.TypeActivator.md)
...
### <a id="Flowthru_Core_Steps_Factory_TypeActivator_CacheCount"></a> CacheCount
...
### <a id="Flowthru_Core_Steps_Factory_TypeActivator_ClearCache"></a> ClearCache\(\)
...
### <a id="Flowthru_Core_Steps_Factory_TypeActivator_Create__1"></a> Create<T\>\(\)
