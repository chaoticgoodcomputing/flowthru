# <a id="Flowthru_Data_Storage_IContainerAdapter_2"></a> Interface IContainerAdapter<TContainer, TRow\>
...
- Serialization format (CSV vs JSON) - handled by <xref href="Flowthru.Data.Storage.IFormatSerializer%601" data-throw-if-not-resolved="false"></xref>
</p>
<p>
...
### <a id="Flowthru_Data_Storage_IContainerAdapter_2_FromRows_System_Collections_Generic_IAsyncEnumerable__1__"></a> FromRows\(IAsyncEnumerable<TRow\>\)
...
### <a id="Flowthru_Data_Storage_IContainerAdapter_2_ToRows__0_"></a> ToRows\(TContainer\)
