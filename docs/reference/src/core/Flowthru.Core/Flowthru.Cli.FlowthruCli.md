# <a id="Flowthru_Cli_FlowthruCli"></a> Class FlowthruCli
...
### <a id="Flowthru_Cli_FlowthruCli__ctor_Flowthru_Services_IFlowthruService_Microsoft_Extensions_Logging_ILogger_Flowthru_Cli_FlowthruCli__System_IO_TextWriter_"></a> FlowthruCli\(IFlowthruService, ILogger<FlowthruCli\>, TextWriter?\)
...
`service` [IFlowthruService](Flowthru.Services.IFlowthruService.md)

Flowthru service

`logger` [ILogger](https://learn.microsoft.com/dotnet/api/microsoft.extensions.logging.ilogger\-1)<[FlowthruCli](Flowthru.Cli.FlowthruCli.md)\>
...
### <a id="Flowthru_Cli_FlowthruCli_RunAsync_System_String___System_Threading_CancellationToken_"></a> RunAsync\(string\[\], CancellationToken\)
...
### <a id="Flowthru_Cli_FlowthruCli_RunStandaloneAsync_System_String___System_Action_Microsoft_Extensions_DependencyInjection_IServiceCollection__System_Threading_CancellationToken_"></a> RunStandaloneAsync\(string\[\], Action<IServiceCollection\>, CancellationToken\)
