# <a id="Flowthru_Core_Data_Storage_Strategies_MemoryStorageEntryFactory"></a> Class MemoryStorageEntryFactory
...
[MemoryStorageEntryFactory](Flowthru.Core.Data.Storage.Strategies.MemoryStorageEntryFactory.md)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_MemoryStorageEntryFactory_CreateEnumerable__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateEnumerable<T\>\(string, StorageOptions?\)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_MemoryStorageEntryFactory_CreateSingle__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateSingle<T\>\(string, StorageOptions?\)
