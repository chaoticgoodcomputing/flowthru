# <a id="Flowthru_Abstractions_ITextSerializable"></a> Interface ITextSerializable
...
<ul><li>Also implement <xref href="Flowthru.Abstractions.IFlatSchema" data-throw-if-not-resolved="false"></xref> (no nested structures)</li><li>Have properties that can be converted to/from string representation</li><li>Support single-value serialization per field</li></ul>
<p>
...
<p>
Most flat schemas should implement both <xref href="Flowthru.Abstractions.ITextSerializable" data-throw-if-not-resolved="false"></xref> and
<xref href="Flowthru.Abstractions.IBinarySerializable" data-throw-if-not-resolved="false"></xref> to support maximum format flexibility.
</p>
