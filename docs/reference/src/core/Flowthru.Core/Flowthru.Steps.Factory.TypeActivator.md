# <a id="Flowthru_Steps_Factory_TypeActivator"></a> Class TypeActivator
...
### <a id="Flowthru_Steps_Factory_TypeActivator_CacheCount"></a> CacheCount
...
### <a id="Flowthru_Steps_Factory_TypeActivator_ClearCache"></a> ClearCache\(\)
...
### <a id="Flowthru_Steps_Factory_TypeActivator_Create__1"></a> Create<T\>\(\)
