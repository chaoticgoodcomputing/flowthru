# <a id="Flowthru_Data_EnumerableItemFactory"></a> Class EnumerableItemFactory
...
### <a id="Flowthru_Data_EnumerableItemFactory_Json__1_System_String_System_String_"></a> Json<TRow\>\(string, string\)
...
### <a id="Flowthru_Data_EnumerableItemFactory_Memory__1_System_String_"></a> Memory<TRow\>\(string\)
