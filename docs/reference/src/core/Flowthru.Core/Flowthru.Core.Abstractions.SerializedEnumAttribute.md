# <a id="Flowthru_Core_Abstractions_SerializedEnumAttribute"></a> Class SerializedEnumAttribute
...
### <a id="Flowthru_Core_Abstractions_SerializedEnumAttribute__ctor_System_String_"></a> SerializedEnumAttribute\(string\)

Initializes a new instance of the <xref href="Flowthru.Core.Abstractions.SerializedEnumAttribute" data-throw-if-not-resolved="false"></xref> class.
...
### <a id="Flowthru_Core_Abstractions_SerializedEnumAttribute_Value"></a> Value
