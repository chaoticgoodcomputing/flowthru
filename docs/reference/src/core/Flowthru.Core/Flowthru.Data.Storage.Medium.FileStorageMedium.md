# <a id="Flowthru_Data_Storage_Medium_FileStorageMedium"></a> Class FileStorageMedium
...
[FileStorageMedium](Flowthru.Data.Storage.Medium.FileStorageMedium.md)
...
### <a id="Flowthru_Data_Storage_Medium_FileStorageMedium__ctor_System_String_"></a> FileStorageMedium\(string\)
...
### <a id="Flowthru_Data_Storage_Medium_FileStorageMedium_FilePath"></a> FilePath
...
### <a id="Flowthru_Data_Storage_Medium_FileStorageMedium_Traits"></a> Traits
...
### <a id="Flowthru_Data_Storage_Medium_FileStorageMedium_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Data_Storage_Medium_FileStorageMedium_ReadStream"></a> ReadStream\(\)
...
### <a id="Flowthru_Data_Storage_Medium_FileStorageMedium_WriteStream_System_IO_Stream_"></a> WriteStream\(Stream\)
