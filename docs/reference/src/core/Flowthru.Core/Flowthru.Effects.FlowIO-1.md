# <a id="Flowthru_Effects_FlowIO_1"></a> Struct FlowIO<A\>
...
<p>
<xref href="Flowthru.Effects.FlowIO%601" data-throw-if-not-resolved="false"></xref> is a lightweight effect monad for representing I/O operations.
It provides:
</p>
<ul><li>Lazy evaluation - effects don't run until <xref href="Flowthru.Effects.FlowIO%601.Run(System.Threading.CancellationToken)" data-throw-if-not-resolved="false"></xref> is called</li><li>Cancellation support - all effects accept a <xref href="System.Threading.CancellationToken" data-throw-if-not-resolved="false"></xref></li><li>Functor/Monad operations - <xref href="Flowthru.Effects.FlowIO%601.Map%60%601(System.Func%7b%600%2c%60%600%7d)" data-throw-if-not-resolved="false"></xref>, <xref href="Flowthru.Effects.FlowIO%601.Bind%60%601(System.Func%7b%600%2cFlowthru.Effects.FlowIO%7b%60%600%7d%7d)" data-throw-if-not-resolved="false"></xref></li><li>LINQ comprehension syntax - via <xref href="Flowthru.Effects.FlowIO%601.Select%60%601(System.Func%7b%600%2c%60%600%7d)" data-throw-if-not-resolved="false"></xref> and <xref href="Flowthru.Effects.FlowIO%601.SelectMany%60%602(System.Func%7b%600%2cFlowthru.Effects.FlowIO%7b%60%600%7d%7d%2cSystem.Func%7b%600%2c%60%600%2c%60%601%7d)" data-throw-if-not-resolved="false"></xref></li></ul>
<p>
...
### <a id="Flowthru_Effects_FlowIO_1_Bind__1_System_Func__0_Flowthru_Effects_FlowIO___0___"></a> Bind<B\>\(Func<A, FlowIO<B\>\>\)
...
#### Returns
 ...
 [FlowIO](Flowthru.Effects.FlowIO\-1.md)<B\>
...
### <a id="Flowthru_Effects_FlowIO_1_Catch_System_Func_System_Exception_Flowthru_Effects_FlowIO__0___"></a> Catch\(Func<Exception, FlowIO<A\>\>\)
...
`handler` [Func](https://learn.microsoft.com/dotnet/api/system.func\-2)<[Exception](https://learn.microsoft.com/dotnet/api/system.exception), [FlowIO](Flowthru.Effects.FlowIO\-1.md)<A\>\>
...
### <a id="Flowthru_Effects_FlowIO_1_Catch__1_System_Func___0_Flowthru_Effects_FlowIO__0___"></a> Catch<TException\>\(Func<TException, FlowIO<A\>\>\)
...
`handler` [Func](https://learn.microsoft.com/dotnet/api/system.func\-2)<TException, [FlowIO](Flowthru.Effects.FlowIO\-1.md)<A\>\>
...
### <a id="Flowthru_Effects_FlowIO_1_IfFail__0_"></a> IfFail\(A\)
...
### <a id="Flowthru_Effects_FlowIO_1_IfFail_Flowthru_Effects_FlowIO__0__"></a> IfFail\(FlowIO<A\>\)
...
`alternative` [FlowIO](Flowthru.Effects.FlowIO\-1.md)<A\>
...
### <a id="Flowthru_Effects_FlowIO_1_Map__1_System_Func__0___0__"></a> Map<B\>\(Func<A, B\>\)
...
### <a id="Flowthru_Effects_FlowIO_1_MapAsync__1_System_Func__0_System_Threading_Tasks_Task___0___"></a> MapAsync<B\>\(Func<A, Task<B\>\>\)
...
### <a id="Flowthru_Effects_FlowIO_1_Run_System_Threading_CancellationToken_"></a> Run\(CancellationToken\)
...
### <a id="Flowthru_Effects_FlowIO_1_Select__1_System_Func__0___0__"></a> Select<B\>\(Func<A, B\>\)

Transforms this effect using the specified function (alias for <xref href="Flowthru.Effects.FlowIO%601.Map%60%601(System.Func%7b%600%2c%60%600%7d)" data-throw-if-not-resolved="false"></xref>).
...
### <a id="Flowthru_Effects_FlowIO_1_SelectMany__2_System_Func__0_Flowthru_Effects_FlowIO___0___System_Func__0___0___1__"></a> SelectMany<B, C\>\(Func<A, FlowIO<B\>\>, Func<A, B, C\>\)
...
`bind` [Func](https://learn.microsoft.com/dotnet/api/system.func\-2)<A, [FlowIO](Flowthru.Effects.FlowIO\-1.md)<B\>\>
...
#### Returns
 ...
 [FlowIO](Flowthru.Effects.FlowIO\-1.md)<C\>
