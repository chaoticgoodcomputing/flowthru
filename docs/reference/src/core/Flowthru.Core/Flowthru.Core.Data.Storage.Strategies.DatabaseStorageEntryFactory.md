# <a id="Flowthru_Core_Data_Storage_Strategies_DatabaseStorageEntryFactory"></a> Class DatabaseStorageEntryFactory

Namespace: [Flowthru.Core.Data.Storage.Strategies](Flowthru.Core.Data.Storage.Strategies.md)  
...
[DatabaseStorageEntryFactory](Flowthru.Core.Data.Storage.Strategies.DatabaseStorageEntryFactory.md)

#### Implements

[IStorageEntryFactory](Flowthru.Core.Data.Storage.Strategies.IStorageEntryFactory.md)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_DatabaseStorageEntryFactory_CreateEnumerable__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateEnumerable<T\>\(string, StorageOptions?\)
...
`options` [StorageOptions](Flowthru.Core.Data.Storage.Strategies.StorageOptions.md)?

Optional storage options

#### Returns

 [IItem](Flowthru.Core.Data.IItem\-1.md)<[IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable\-1)<T\>\>
...
### <a id="Flowthru_Core_Data_Storage_Strategies_DatabaseStorageEntryFactory_CreateSingle__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateSingle<T\>\(string, StorageOptions?\)
