# <a id="Flowthru_Flows_FlowStep"></a> Class FlowStep
...
#### Property Value
 ...
 [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[FlowStep](Flowthru.Flows.FlowStep.md)\>
...
### <a id="Flowthru_Flows_FlowStep_Description"></a> Description
...
### <a id="Flowthru_Flows_FlowStep_Inputs"></a> Inputs
...
### <a id="Flowthru_Flows_FlowStep_Label"></a> Label
...
### <a id="Flowthru_Flows_FlowStep_Layer"></a> Layer
...
### <a id="Flowthru_Flows_FlowStep_Outputs"></a> Outputs
...
### <a id="Flowthru_Flows_FlowStep_TransformFunction"></a> TransformFunction
...
### <a id="Flowthru_Flows_FlowStep_ToString"></a> ToString\(\)
