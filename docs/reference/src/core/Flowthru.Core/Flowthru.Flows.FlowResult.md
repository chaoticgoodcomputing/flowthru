# <a id="Flowthru_Flows_FlowResult"></a> Class FlowResult
...
### <a id="Flowthru_Flows_FlowResult_IsDryRun"></a> IsDryRun
...
### <a id="Flowthru_Flows_FlowResult_StepResults"></a> StepResults
...
#### Property Value
 ...
 [Dictionary](https://learn.microsoft.com/dotnet/api/system.collections.generic.dictionary\-2)<[string](https://learn.microsoft.com/dotnet/api/system.string), [StepResult](Flowthru.Flows.StepResult.md)\>
...
### <a id="Flowthru_Flows_FlowResult_CreateDryRunSuccess_System_TimeSpan_System_Int32_System_Int32_System_Int32_System_String_"></a> CreateDryRunSuccess\(TimeSpan, int, int, int, string?\)
...
`stepResults` [Dictionary](https://learn.microsoft.com/dotnet/api/system.collections.generic.dictionary\-2)<[string](https://learn.microsoft.com/dotnet/api/system.string), [StepResult](Flowthru.Flows.StepResult.md)\>?
