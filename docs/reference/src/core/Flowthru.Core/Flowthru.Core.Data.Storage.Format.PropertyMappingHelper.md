# <a id="Flowthru_Core_Data_Storage_Format_PropertyMappingHelper"></a> Class PropertyMappingHelper
...
### <a id="Flowthru_Core_Data_Storage_Format_PropertyMappingHelper_BuildPropertyMap__1"></a> BuildPropertyMap<T\>\(\)
...
### <a id="Flowthru_Core_Data_Storage_Format_PropertyMappingHelper_GetFieldName_System_Reflection_PropertyInfo_"></a> GetFieldName\(PropertyInfo\)
