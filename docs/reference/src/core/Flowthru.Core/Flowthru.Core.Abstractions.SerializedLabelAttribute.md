# <a id="Flowthru_Core_Abstractions_SerializedLabelAttribute"></a> Class SerializedLabelAttribute
...
<pre><code class="lang-csharp">// Tier 1: No annotation - property name matches external field name
...
<ul><li>snake_case data sources: <code>[SerializedLabel("company_id")] int CompanyId</code></li><li>kebab-case data sources: <code>[SerializedLabel("company-id")] int CompanyId</code></li><li>Space-separated names: <code>[SerializedLabel("Company ID")] int CompanyId</code></li><li>Legacy column names: <code>[SerializedLabel("CMPNY_ID")] int CompanyId</code></li></ul>

## Constructors

### <a id="Flowthru_Core_Abstractions_SerializedLabelAttribute__ctor_System_String_"></a> SerializedLabelAttribute\(string\)

Initializes a new instance of the <xref href="Flowthru.Core.Abstractions.SerializedLabelAttribute" data-throw-if-not-resolved="false"></xref> class.
...
### <a id="Flowthru_Core_Abstractions_SerializedLabelAttribute_Label"></a> Label
