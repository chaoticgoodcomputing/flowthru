# <a id="Flowthru_Core_Data_FlowthruConfigAttribute"></a> Class FlowthruConfigAttribute
...
<p>
The annotated class must be declared <code>partial</code> so the generator can add
the base class and constructor without conflicting with user-authored members.
</p>
<p>
<strong>Example:</strong>
<pre><code class="lang-csharp">[FlowthruConfig]
