# <a id="Flowthru_Abstractions_SerializedLabelAttribute"></a> Class SerializedLabelAttribute
...
### <a id="Flowthru_Abstractions_SerializedLabelAttribute__ctor_System_String_"></a> SerializedLabelAttribute\(string\)

Initializes a new instance of the <xref href="Flowthru.Abstractions.SerializedLabelAttribute" data-throw-if-not-resolved="false"></xref> class.
...
### <a id="Flowthru_Abstractions_SerializedLabelAttribute_Label"></a> Label
