# <a id="Flowthru_Data_Storage_TextFileStorageAdapter"></a> Class TextFileStorageAdapter
...
[IStorageAdapter<string\>](Flowthru.Data.Storage.IStorageAdapter\-1.md)
...
### <a id="Flowthru_Data_Storage_TextFileStorageAdapter__ctor_System_String_"></a> TextFileStorageAdapter\(string\)
...
### <a id="Flowthru_Data_Storage_TextFileStorageAdapter_Traits"></a> Traits
...
### <a id="Flowthru_Data_Storage_TextFileStorageAdapter_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Data_Storage_TextFileStorageAdapter_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Data_Storage_TextFileStorageAdapter_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Data_Storage_TextFileStorageAdapter_Load"></a> Load\(\)
...
#### Returns
 ...
 [FlowIO](Flowthru.Effects.FlowIO\-1.md)<[string](https://learn.microsoft.com/dotnet/api/system.string)\>
...
### <a id="Flowthru_Data_Storage_TextFileStorageAdapter_Save_System_String_"></a> Save\(string\)
