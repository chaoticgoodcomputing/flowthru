# <a id="Flowthru_Data_Storage_Container_EnumerableContainerAdapter_1"></a> Class EnumerableContainerAdapter<T\>

Namespace: [Flowthru.Data.Storage.Container](Flowthru.Data.Storage.Container.md)  
...
[EnumerableContainerAdapter<T\>](Flowthru.Data.Storage.Container.EnumerableContainerAdapter\-1.md)

#### Implements

[IContainerAdapter<IEnumerable<T\>, T\>](Flowthru.Data.Storage.IContainerAdapter\-2.md)
...
<ul><li><strong>Large datasets:</strong> Use DataViewContainerAdapter&lt;T&gt; for ML.NET IDataView</li><li><strong>Lazy evaluation:</strong> Use SeqContainerAdapter&lt;T&gt; for LanguageExt Seq</li></ul>

## Constructors

### <a id="Flowthru_Data_Storage_Container_EnumerableContainerAdapter_1__ctor"></a> EnumerableContainerAdapter\(\)
...
### <a id="Flowthru_Data_Storage_Container_EnumerableContainerAdapter_1_FromRows_System_Collections_Generic_IAsyncEnumerable__0__"></a> FromRows\(IAsyncEnumerable<T\>\)
...
### <a id="Flowthru_Data_Storage_Container_EnumerableContainerAdapter_1_ToRows_System_Collections_Generic_IEnumerable__0__"></a> ToRows\(IEnumerable<T\>\)
