# <a id="Flowthru_Data_ItemFactory"></a> Class ItemFactory
...
### <a id="Flowthru_Data_ItemFactory_Enumerable"></a> Enumerable
...
### <a id="Flowthru_Data_ItemFactory_Null__1_System_String_"></a> Null<T\>\(string\)
