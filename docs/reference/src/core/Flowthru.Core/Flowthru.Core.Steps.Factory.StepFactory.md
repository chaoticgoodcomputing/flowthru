# <a id="Flowthru_Core_Steps_Factory_StepFactory"></a> Class StepFactory
...
[StepFactory](Flowthru.Core.Steps.Factory.StepFactory.md)
...
### <a id="Flowthru_Core_Steps_Factory_StepFactory_Create__1"></a> Create<TStep\>\(\)
