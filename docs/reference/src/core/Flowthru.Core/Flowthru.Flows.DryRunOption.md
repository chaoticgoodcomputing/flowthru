# <a id="Flowthru_Flows_DryRunOption"></a> Struct DryRunOption
...
### <a id="Flowthru_Flows_DryRunOption_Depth"></a> Depth
...
### <a id="Flowthru_Flows_DryRunOption_Enabled"></a> Enabled
...
### <a id="Flowthru_Flows_DryRunOption_op_Implicit_System_Boolean__Flowthru_Flows_DryRunOption"></a> implicit operator DryRunOption\(bool\)
...
### <a id="Flowthru_Flows_DryRunOption_op_Implicit_Flowthru_Flows_ValidationDepth__Flowthru_Flows_DryRunOption"></a> implicit operator DryRunOption\(ValidationDepth\)
