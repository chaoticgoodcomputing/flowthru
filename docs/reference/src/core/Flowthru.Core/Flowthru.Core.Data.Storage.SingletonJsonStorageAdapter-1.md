# <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1"></a> Class SingletonJsonStorageAdapter<T\>
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1__ctor_System_String_"></a> SingletonJsonStorageAdapter\(string\)
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_FilePath"></a> FilePath
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_Options"></a> Options
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_Traits"></a> Traits
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_InspectTarget"></a> InspectTarget\(\)
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_Load"></a> Load\(\)
...
### <a id="Flowthru_Core_Data_Storage_SingletonJsonStorageAdapter_1_Save__0_"></a> Save\(T\)
