# <a id="Flowthru_Data_Storage_NullStorageAdapter_1"></a> Class NullStorageAdapter<T\>
...
### <a id="Flowthru_Data_Storage_NullStorageAdapter_1_Traits"></a> Traits
...
### <a id="Flowthru_Data_Storage_NullStorageAdapter_1_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Data_Storage_NullStorageAdapter_1_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Data_Storage_NullStorageAdapter_1_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Data_Storage_NullStorageAdapter_1_Load"></a> Load\(\)
...
### <a id="Flowthru_Data_Storage_NullStorageAdapter_1_Save__0_"></a> Save\(T\)
