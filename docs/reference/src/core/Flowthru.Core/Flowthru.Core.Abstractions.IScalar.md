# <a id="Flowthru_Core_Abstractions_IScalar"></a> Interface IScalar
...
<p>
<strong>Relationship with <xref href="Flowthru.Core.Abstractions.IFlatSchema" data-throw-if-not-resolved="false"></xref>:</strong>
</p>
<p>
<xref href="Flowthru.Core.Abstractions.IFlatSchema" data-throw-if-not-resolved="false"></xref> marks a <em>row type</em> — a schema whose properties are all
scalars. <xref href="Flowthru.Core.Abstractions.IScalar" data-throw-if-not-resolved="false"></xref> marks a <em>property type</em> — a single value that can
