...
### <a id="Flowthru_Meta_Providers_JsonMetadataProvider__ctor_System_String_System_String_Flowthru_Meta_TimestampConfiguration_System_Boolean_Microsoft_Extensions_Logging_ILogger_"></a> JsonMetadataProvider\(string, string, TimestampConfiguration, bool, ILogger?\)
...
### <a id="Flowthru_Meta_Providers_JsonMetadataProvider_Consume_Flowthru_Meta_Models_DagMetadata_"></a> Consume\(DagMetadata\)
