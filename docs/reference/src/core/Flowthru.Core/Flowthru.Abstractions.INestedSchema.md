# <a id="Flowthru_Abstractions_INestedSchema"></a> Interface INestedSchema
...
<ul><li><xref href="Flowthru.Abstractions.IFlatSchema" data-throw-if-not-resolved="false"></xref> - All primitive properties</li><li><xref href="Flowthru.Abstractions.INestedSchema" data-throw-if-not-resolved="false"></xref> - Contains collections or nested objects</li></ul>
