# <a id="Flowthru_Core_Data_Storage_Strategies_IStorageEntryFactory"></a> Interface IStorageEntryFactory
...
### <a id="Flowthru_Core_Data_Storage_Strategies_IStorageEntryFactory_CreateEnumerable__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateEnumerable<T\>\(string, StorageOptions?\)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_IStorageEntryFactory_CreateSingle__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateSingle<T\>\(string, StorageOptions?\)
