# <a id="Flowthru_Configuration_ConfigurationExtensions"></a> Class ConfigurationExtensions
...
### <a id="Flowthru_Configuration_ConfigurationExtensions_GetValidated__1_Microsoft_Extensions_Configuration_IConfiguration_System_String_"></a> GetValidated<T\>\(IConfiguration, string\)
...
### <a id="Flowthru_Configuration_ConfigurationExtensions_GetValidatedOrDefault__1_Microsoft_Extensions_Configuration_IConfiguration_System_String_"></a> GetValidatedOrDefault<T\>\(IConfiguration, string\)
