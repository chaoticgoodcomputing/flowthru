...
[IMetadataProvider](Flowthru.Meta.Providers.IMetadataProvider.md)
...
### <a id="Flowthru_Meta_Providers_MermaidMetadataProvider__ctor_System_String_System_String_Flowthru_Meta_TimestampConfiguration_Flowthru_Meta_Providers_MermaidMetadataProvider_MermaidFlowchartDirection_System_String_System_String_Microsoft_Extensions_Logging_ILogger_"></a> MermaidMetadataProvider\(string, string, TimestampConfiguration, MermaidFlowchartDirection, string, string, ILogger?\)
...
`timestampConfig` [TimestampConfiguration](Flowthru.Meta.TimestampConfiguration.md)
...
### <a id="Flowthru_Meta_Providers_MermaidMetadataProvider_Consume_Flowthru_Meta_Models_DagMetadata_"></a> Consume\(DagMetadata\)
