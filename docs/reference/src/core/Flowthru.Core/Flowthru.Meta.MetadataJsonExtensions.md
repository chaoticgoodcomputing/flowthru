...
### <a id="Flowthru_Meta_MetadataJsonExtensions_ToCompactJson_Flowthru_Meta_Models_DagMetadata_"></a> ToCompactJson\(DagMetadata\)
...
`metadata` [DagMetadata](Flowthru.Meta.Models.DagMetadata.md)
...
### <a id="Flowthru_Meta_MetadataJsonExtensions_ToJson_Flowthru_Meta_Models_DagMetadata_"></a> ToJson\(DagMetadata\)
