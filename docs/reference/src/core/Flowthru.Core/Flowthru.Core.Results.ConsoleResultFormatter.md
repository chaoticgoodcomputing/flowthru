# <a id="Flowthru_Core_Results_ConsoleResultFormatter"></a> Class ConsoleResultFormatter
...
### <a id="Flowthru_Core_Results_ConsoleResultFormatter_Format_Flowthru_Core_Flows_FlowResult_Microsoft_Extensions_Logging_ILogger_"></a> Format\(FlowResult, ILogger\)
