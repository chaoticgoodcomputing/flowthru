# <a id="Flowthru_Core_Abstractions_IBinarySerializable"></a> Interface IBinarySerializable
...
<ul><li><strong>Flat schemas (<xref href="Flowthru.Core.Abstractions.IFlatSchema" data-throw-if-not-resolved="false"></xref>):</strong> Optimal - full columnar compression</li><li><strong>Nested schemas (<xref href="Flowthru.Core.Abstractions.INestedSchema" data-throw-if-not-resolved="false"></xref>):</strong> Supported but may lose some benefits</li></ul>
<p>
