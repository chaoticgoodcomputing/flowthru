# <a id="Flowthru_Data_ItemFactory_Single"></a> Class ItemFactory.Single
...
```csharp
public static class ItemFactory.Single
```
...
### <a id="Flowthru_Data_ItemFactory_Single_Binary_System_String_System_String_"></a> Binary\(string, string\)
...
### <a id="Flowthru_Data_ItemFactory_Single_Json__1_System_String_System_String_"></a> Json<T\>\(string, string\)
...
### <a id="Flowthru_Data_ItemFactory_Single_Memory__1_System_String_"></a> Memory<T\>\(string\)
...
### <a id="Flowthru_Data_ItemFactory_Single_Null__1_System_String_"></a> Null<T\>\(string\)
...
### <a id="Flowthru_Data_ItemFactory_Single_Text_System_String_System_String_"></a> Text\(string, string\)
