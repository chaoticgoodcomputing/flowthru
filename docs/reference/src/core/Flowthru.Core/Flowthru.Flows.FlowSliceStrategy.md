# <a id="Flowthru_Flows_FlowSliceStrategy"></a> Class FlowSliceStrategy
...
### <a id="Flowthru_Flows_FlowSliceStrategy_Flows"></a> Flows
...
### <a id="Flowthru_Flows_FlowSliceStrategy_All"></a> All\(\)
