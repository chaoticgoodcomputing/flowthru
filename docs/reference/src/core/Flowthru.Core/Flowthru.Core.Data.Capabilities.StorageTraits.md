# <a id="Flowthru_Core_Data_Capabilities_StorageTraits"></a> Class StorageTraits

Namespace: [Flowthru.Core.Data.Capabilities](Flowthru.Core.Data.Capabilities.md)  
...
```csharp
public record StorageTraits : NodeTraits, IEquatable<NodeTraits>, IEquatable<StorageTraits>
```
...
### <a id="Flowthru_Core_Data_Capabilities_StorageTraits_CanAppend"></a> CanAppend
...
### <a id="Flowthru_Core_Data_Capabilities_StorageTraits_CanRead"></a> CanRead
...
### <a id="Flowthru_Core_Data_Capabilities_StorageTraits_CanStream"></a> CanStream
...
### <a id="Flowthru_Core_Data_Capabilities_StorageTraits_CanWrite"></a> CanWrite
...
### <a id="Flowthru_Core_Data_Capabilities_StorageTraits_IsPersistent"></a> IsPersistent
...
### <a id="Flowthru_Core_Data_Capabilities_StorageTraits_IsTransactional"></a> IsTransactional
