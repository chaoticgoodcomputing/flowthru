# <a id="Flowthru_Core_Data_Storage_SchemaActivator"></a> Class SchemaActivator
...
### <a id="Flowthru_Core_Data_Storage_SchemaActivator_CreateInstance__1"></a> CreateInstance<T\>\(\)
