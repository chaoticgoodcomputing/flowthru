# <a id="Flowthru_Core_Abstractions_INestedSerializable"></a> Interface INestedSerializable
...
<ul><li><xref href="Flowthru.Core.Abstractions.IFlatSerializable" data-throw-if-not-resolved="false"></xref> - All primitive properties, CSV-compatible</li><li><xref href="Flowthru.Core.Abstractions.INestedSerializable" data-throw-if-not-resolved="false"></xref> - Contains collections or nested objects</li></ul>
