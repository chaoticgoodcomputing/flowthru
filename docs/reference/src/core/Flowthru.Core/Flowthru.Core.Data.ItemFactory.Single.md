# <a id="Flowthru_Core_Data_ItemFactory_Single"></a> Class ItemFactory.Single
...
### <a id="Flowthru_Core_Data_ItemFactory_Single_Binary_System_String_System_String_"></a> Binary\(string, string\)
...
#### Returns
 ...
 [Item](Flowthru.Core.Data.Item\-1.md)<[byte](https://learn.microsoft.com/dotnet/api/system.byte)\[\]\>
...
### <a id="Flowthru_Core_Data_ItemFactory_Single_Memory__1_System_String_"></a> Memory<T\>\(string\)
...
#### Returns
 ...
 [Item](Flowthru.Core.Data.Item\-1.md)<[string](https://learn.microsoft.com/dotnet/api/system.string)\>
