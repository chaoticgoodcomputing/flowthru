# <a id="Flowthru_FUnit_StepTestAttribute"></a> Class StepTestAttribute
...
### <a id="Flowthru_FUnit_StepTestAttribute__ctor_System_Type_"></a> StepTestAttribute\(Type\)
...
```csharp
public StepTestAttribute(Type stepType)
```
...
The step class annotated with <code>[FlowthruStep]</code> that this test exercises.

## Properties

### <a id="Flowthru_FUnit_StepTestAttribute_StepType"></a> StepType

The step type this test exercises.
