# <a id="Flowthru_Core_Data_Storage_Strategies_CsvStorageEntryFactory"></a> Class CsvStorageEntryFactory
...
[CsvStorageEntryFactory](Flowthru.Core.Data.Storage.Strategies.CsvStorageEntryFactory.md)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_CsvStorageEntryFactory__ctor_Microsoft_Extensions_Configuration_IConfiguration_"></a> CsvStorageEntryFactory\(IConfiguration\)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_CsvStorageEntryFactory__ctor_System_String_"></a> CsvStorageEntryFactory\(string\)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_CsvStorageEntryFactory_CreateEnumerable__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateEnumerable<T\>\(string, StorageOptions?\)
...
### <a id="Flowthru_Core_Data_Storage_Strategies_CsvStorageEntryFactory_CreateSingle__1_System_String_Flowthru_Core_Data_Storage_Strategies_StorageOptions_"></a> CreateSingle<T\>\(string, StorageOptions?\)
