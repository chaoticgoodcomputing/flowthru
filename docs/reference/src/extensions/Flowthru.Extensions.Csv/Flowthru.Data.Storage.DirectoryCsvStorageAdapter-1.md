# <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1"></a> Class DirectoryCsvStorageAdapter<TRow\>
...
[DirectoryCsvStorageAdapter<TRow\>](Flowthru.Data.Storage.DirectoryCsvStorageAdapter\-1.md)
...
<xref href="Flowthru.Data.Storage.Format.CsvFormatSerializer%601" data-throw-if-not-resolved="false"></xref>, and returns all rows concatenated.
</p>
<p>
...
### <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1__ctor_System_String_"></a> DirectoryCsvStorageAdapter\(string\)
...
### <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1_Traits"></a> Traits
...
### <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1_Load"></a> Load\(\)
...
### <a id="Flowthru_Data_Storage_DirectoryCsvStorageAdapter_1_Save_System_Collections_Generic_IEnumerable__0__"></a> Save\(IEnumerable<TRow\>\)
