# <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2"></a> Class GqlQueryStorageAdapter<TResult, T\>
...
```csharp
public sealed class GqlQueryStorageAdapter<TResult, T> : IStorageAdapter<GqlQuery<TResult, T>> where TResult : class where T : class
```
...
IStorageAdapter<GqlQuery<TResult, T\>\>
...
than an eagerly-fetched <code>IEnumerable&lt;T&gt;</code>. No network I/O happens during
<xref href="Flowthru.Core.Data.Storage.GqlQueryStorageAdapter%602.Load" data-throw-if-not-resolved="false"></xref>; the handle is passed by value to the step, which decides when to
materialize by calling <code>ToList</code> / <code>ToListAsync</code>.
</p>
<p>
<xref href="Flowthru.Core.Data.Storage.GqlQueryStorageAdapter%602.InspectShallow(System.Int32)" data-throw-if-not-resolved="false"></xref> makes a single-page probe query to validate endpoint
...
### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2__ctor_Flowthru_Extensions_GQL_Data_GqlQuery__0__1__"></a> GqlQueryStorageAdapter\(GqlQuery<TResult, T\>\)
...
`query` [GqlQuery](Flowthru.Extensions.GQL.Data.GqlQuery\-2.md)<TResult, T\>

The pre-built deferred query handle. Constructed by
<xref href="Flowthru.Extensions.GQL.Data.GqlItemFactory.Query" data-throw-if-not-resolved="false"></xref>.

## Properties

### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2_Traits"></a> Traits
...
### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2_Exists"></a> Exists\(\)
...
### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2_InspectDeep"></a> InspectDeep\(\)
...
### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2_InspectShallow_System_Int32_"></a> InspectShallow\(int\)
...
### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2_InspectTarget"></a> InspectTarget\(\)
...
### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2_Load"></a> Load\(\)

Loads data from storage.

```csharp
public FlowIO<GqlQuery<TResult, T>> Load()
```

#### Returns

 FlowIO<[GqlQuery](Flowthru.Extensions.GQL.Data.GqlQuery\-2.md)<TResult, T\>\>
...
### <a id="Flowthru_Core_Data_Storage_GqlQueryStorageAdapter_2_Save_Flowthru_Extensions_GQL_Data_GqlQuery__0__1__"></a> Save\(GqlQuery<TResult, T\>\)
...
`data` [GqlQuery](Flowthru.Extensions.GQL.Data.GqlQuery\-2.md)<TResult, T\>
