...
Builder for configuring <xref href="Flowthru.Meta.Providers.JsonMetadataProvider" data-throw-if-not-resolved="false"></xref> options.
...
### <a id="Flowthru_Meta_JsonMetadataProviderBuilder_WithRunFilenameTemplate_System_String_"></a> WithRunFilenameTemplate\(string\)
