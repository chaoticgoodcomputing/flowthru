# <a id="Flowthru_Data_ParquetItemExtensions"></a> Class ParquetItemExtensions

Namespace: [Flowthru.Data](Flowthru.Data.md)  
Assembly: Flowthru.Extensions.Parquet.dll  

Extension methods that add Parquet support to <xref href="Flowthru.Data.ItemFactory.Enumerable" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Flowthru_Data_ParquetItemExtensions_Parquet__1_Flowthru_Data_EnumerableItemFactory_System_String_System_String_"></a> Parquet<TRow\>\(EnumerableItemFactory, string, string\)
