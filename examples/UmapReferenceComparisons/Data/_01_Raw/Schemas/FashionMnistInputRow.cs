...
/// <summary>
/// Input row for the Fashion-MNIST dataset (28x28 grayscale images).
/// </summary>
/// <remarks>
/// The Fashion-MNIST dataset contains 70,000 samples of 28x28 pixel grayscale images
/// of clothing items. Each pixel value ranges from 0-255.
...
public record FashionMnistInputRow : IFlatSchema, IBinarySerializable, IStructuredSerializable
{
  ...
  /// <summary>
  /// Class label (0-9 for clothing categories).
  /// </summary>
