...
using UmapReferenceComparisons.Flows.IrisComparison.Steps;
using UmapReferenceComparisons.Helpers.Steps;

namespace UmapReferenceComparisons.Flows.IrisComparison;

/// <summary>
/// Flow to compare C# UMAP implementation against Python reference for Iris dataset.
/// </summary>
/// <remarks>
...
/// </remarks>
public static class IrisComparisonFlow
{
    public static Flow Create(Catalog catalog)
    {
        ...
        """,
          transform: ConvertIrisToUmapInputStep.Create(),
