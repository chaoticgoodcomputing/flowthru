...
public partial class Catalog
{
  ...
  public IItem<CrossValidationResults> CrossValidationResults =>
    CreateItem(
      () =>
        Items.Single.Json<CrossValidationResults>(
  ...
  public IItem<GenericChart> CrossValidationChart =>
    CreateItem(() => Items.Single.Memory<GenericChart>(label: "CrossValidationChart"));
  ...
  public IItem<GenericChart> PredictionScatterChart =>
    CreateItem(() => Items.Single.Memory<GenericChart>(label: "PredictionScatterChart"));
