...
/// <summary>
/// EF Core context for the ephemeral <c>staging</c> schema. Three tables —
/// companies, shuttles, reviews — in their preprocessed (typed) form.
/// <strong>No FK constraints</strong>: staging is the unconstrained
/// scratchpad that DataProcessing fills in any order.
/// </summary>
/// <remarks>
...
public class StagingDbContext : DbContext
{
  ...
  public const string SchemaName = "staging";
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    // All staging tables live under the staging schema. The
    // EphemeralSchema lifecycle hook DROPs/CREATEs this schema each run.
