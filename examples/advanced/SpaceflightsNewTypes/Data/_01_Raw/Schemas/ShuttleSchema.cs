...
/// </summary>
/// <remarks>
/// Declares <c>ShuttleId</c> via <see cref="FlowthruColumnAttribute"/> and references
/// <c>CompanyId</c> declared in <see cref="CompanySchema"/>. The two NewTypes are distinct
/// at compile time even though both wrap <see cref="string"/>.
/// </remarks>
[FlowthruSchema]
public partial record ShuttleSchema
{
  /// <summary>
  /// Unique identifier for the shuttle. Declaration site for <c>ShuttleId</c>.
  /// </summary>
  ...
  /// <summary>
  /// Identifier of the company operating this shuttle. Reuses <c>CompanyId</c>
  /// declared in <see cref="CompanySchema"/> — the generator deduplicates the declaration.
  /// </summary>
  [FlowthruColumn(typeof(string))]
