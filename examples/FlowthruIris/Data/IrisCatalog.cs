...
public class IrisCatalog : DataCatalogBase {
  ...
  /// </summary>
  public ICatalogEntry<IEnumerable<IrisRawSchema>> RawIris => GetOrCreateEntry(() =>
  ...
  public ICatalogEntry<(ITransformer Model, MulticlassClassificationMetrics Metrics)> OvaModel =>
      GetOrCreateEntry(() =>
          new Flowthru.Data.Implementations.MemoryCatalogEntry<(ITransformer, MulticlassClassificationMetrics)>(
              key: "ova_model"
          )
      );
  ...
  /// </summary>
  public ICatalogEntry<byte[]> DataScatterPng => GetOrCreateEntry(() =>
  ...
  /// Stored as PNG image.
  /// </summary>
  public ICatalogEntry<byte[]> SdcaConfusionMatrixPng => GetOrCreateEntry(() =>
      new BinaryFileCatalogEntry(
  ...
  /// Stored as PNG image.
  /// </summary>
  public ICatalogEntry<byte[]> OvaConfusionMatrixPng => GetOrCreateEntry(() =>
      new BinaryFileCatalogEntry(
  ...
  /// </summary>
  public ICatalogEntry<string> SdcaReportMd => GetOrCreateEntry(() =>
  ...
  /// </summary>
  public ICatalogEntry<string> OvaReportMd => GetOrCreateEntry(() =>
      new TextFileCatalogEntry(
          key: "ova_report_md",
