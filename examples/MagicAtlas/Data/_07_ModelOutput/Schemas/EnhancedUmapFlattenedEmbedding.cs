...
/// </list>
/// </remarks>
public record EnhancedUmapFlattenedEmbedding
  : IFlatSchema,
    IBinarySerializable,
    ...
    ITextSerializable
{
  ...
  public required float Component0 { get; init; }

  [SerializedLabel("components")]
  public required float Component1 { get; init; }
  ...
  public bool IsBlue { get; init; } = false;
  public bool IsBlack { get; init; } = false;
  public bool IsRed { get; init; } = false;
  public bool IsGreen { get; init; } = false;
