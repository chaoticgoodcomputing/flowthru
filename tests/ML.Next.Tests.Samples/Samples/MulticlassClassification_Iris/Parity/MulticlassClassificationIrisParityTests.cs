...
public class MulticlassClassificationIrisParityTests {
  ...
  [OneTimeSetUp]
  public void Setup() {
    _trainDataPath = TestHelpers.GetDataPath("Samples/MulticlassClassification_Iris/Data/iris-train.txt");
    _testDataPath = TestHelpers.GetDataPath("Samples/MulticlassClassification_Iris/Data/iris-test.txt");
  }
  ...
  private MulticlassClassificationMetrics RunMLNetPipeline() {
    ...
    var trainingDataView = mlContext.Data.LoadFromTextFile<IrisData>(_trainDataPath, hasHeader: true);
  ...
  public void MLNext_Should_Produce_Identical_Classification_Results_To_MLNet() {
    ...
    Assert.That(mlnextMetrics.MicroAccuracy,
    ...
    Assert.That(mlnextMetrics.MacroAccuracy,
    ...
    Assert.That(mlnextMetrics.LogLoss,
    ...
    Assert.That(mlnextMetrics.LogLossReduction,
