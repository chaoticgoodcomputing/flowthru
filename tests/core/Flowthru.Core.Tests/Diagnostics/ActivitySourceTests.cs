...
/// <see cref="FlowthruActivitySource"/> events. The CLI's
/// <c>FlowthruActivityLogger</c> bridges these into log lines —
/// these tests pin Core's contract so the CLI bridge can stay
/// a pure consumer.
/// </summary>
[TestFixture]
