...
/// <summary>
/// FTPY2009 closes the C# escape-hatch leg of the Python-step error
/// surface: a <c>builder.AddPythonStep&lt;TIn, TOut&gt;(...)</c>
/// call bypasses the <c>@step</c>-decorator codepath that FTPY2008
...
/// </summary>
[TestFixture]
public class Ftpy2009AddPythonStepShapeAnalyzerTests
{
  // ── Happy path ────────────────────────────────────────────────────────
  ...
  public void Marshallable_TIn_And_TOut_FiresNothing()
  {
    ...
    Assert.That(result.Diagnostics.Where("FTPY2009").ToList(), Is.Empty,
      "Both type arguments only carry marshallable properties; FTPY2009 must stay silent.");
  }
  ...
  public void TIn_With_Unmarshallable_Property_FiresFt2009()
  {
    ...
    var ft2009 = result.Diagnostics.Where("FTPY2009").ToList();
    Assert.That(ft2009, Is.Not.Empty,
      "FTPY2009 must fire when a TIn slot reaches an unmarshallable property.");
  ...
  public void TOut_With_Unmarshallable_Property_FiresFt2009()
  {
    ...
    var ft2009 = result.Diagnostics.Where("FTPY2009").ToList();
    Assert.That(ft2009, Is.Not.Empty,
      "FTPY2009 must fire when a TOut slot reaches an unmarshallable property.");
  ...
  public void TIn_As_IEnumerable_Of_BadSchema_FiresFt2009()
  {
    ...
    Assert.That(result.Diagnostics.Where("FTPY2009").ToList(), Is.Not.Empty,
      "FTPY2009 must unwrap IEnumerable<T> and still flag unmarshallable schema properties.");
  }
  ...
  public void TIn_As_ValueTuple_With_Bad_Position_FiresFt2009()
  {
    ...
    var ft2009 = result.Diagnostics.Where("FTPY2009").ToList();
    Assert.That(ft2009, Is.Not.Empty,
      "FTPY2009 must flag the bad slot when a value-tuple TIn mixes good and bad schemas.");
  ...
  public void TIn_As_DirectoryOf_BadSchema_FiresFt2009()
  {
    ...
    Assert.That(result.Diagnostics.Where("FTPY2009").ToList(), Is.Not.Empty,
      "FTPY2009 must unwrap DirectoryOf<T> to its schema and flag unmarshallable properties on it.");
  }
  ...
  public void TIn_As_IEnumerable_Of_ValueTuple_With_BadSlot_FiresFt2009()
  {
    ...
    Assert.That(result.Diagnostics.Where("FTPY2009").ToList(), Is.Not.Empty,
      "FTPY2009 must walk IEnumerable<(A, B)> down into B and flag its unmarshallable property.");
  }

  // ── FTPY2008 + FTPY2009 coexistence ───────────────────────────────────────

  [Test]
  public void Schema_Used_By_Both_Decorator_And_AddPythonStep_FiresBoth()
  {
    // FTPY2008 fires from the @step decorator pass; FTPY2009 fires from the
    ...
    Assert.That(result.Diagnostics.Where("FTPY2008").ToList(), Is.Not.Empty,
      "@step decorator path still fires FTPY2008.");
    Assert.That(result.Diagnostics.Where("FTPY2009").ToList(), Is.Not.Empty,
      "AddPythonStep call-site path additionally fires FTPY2009.");
  }
}
