...
```bash
cd tests/Flowthru.Tests.ML.Next.Samples/Clustering_Iris
mkdir -p Errors
```
...
namespace Flowthru.Tests.ML.Next.Samples.Clustering_Iris.Errors;
...
namespace Flowthru.Tests.ML.Next.Samples.YourSampleName.Errors;
