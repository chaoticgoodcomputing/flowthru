...
namespace Flowthru.Tests.Spark
{
  ...
  public class ColumnTests
  {
    ...
    public void TestColumnNegateOperator()
    {
      ...
      _mockJvm.Verify(
        m => m.CallStaticJavaMethod("org.apache.spark.sql.functions", "negate", column1),
        Times.Once
      );
    ...
    public void TestNotOperator()
    {
      ...
      _mockJvm.Verify(
        m => m.CallStaticJavaMethod("org.apache.spark.sql.functions", "not", column1),
        Times.Once
      );
    ...
    public void TestOver()
    {
      {
        Column column1 = CreateColumn("col1");
        var windowSpec = new WindowSpec(new JvmObjectReference("windowSpec", _mockJvm.Object));
        column1.Over();
    ...
    {
      _mockJvm.Verify(m => m.CallNonStaticJavaMethod(obj.Reference, methodName, arg0));
    }
    ...
    {
      _mockJvm.Verify(m => m.CallNonStaticJavaMethod(obj.Reference, methodName, arg0, arg1));
    }
    ...
    {
      _mockJvm.Verify(m => m.CallNonStaticJavaMethod(obj.Reference, methodName, args));
    }
    ...
    public void TestNamedOperators(string funcName, string opName)
    {
      Column column1 = CreateColumn("col1");
      Column column2 = CreateColumn("col2");
      System.Reflection.MethodInfo func = column1
        .GetType()
        .GetMethod(funcName, new Type[] { typeof(Column) });
    ...
    public void TestNamedOperatorsWithString(string funcName, string opName)
    {
      ...
      System.Reflection.MethodInfo func = column
        .GetType()
        .GetMethod(funcName, new Type[] { typeof(string) });
    ...
    public void TestUnaryOperators(string funcName, string opName)
    {
      ...
      System.Reflection.MethodInfo func = column.GetType().GetMethod(funcName, Type.EmptyTypes);
