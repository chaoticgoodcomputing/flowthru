  ...
  public class TypesTests
  {
    ...
    public void TestArrayTypeFromInternal()
    {
      ...
      }
      {
        ...
        Date[] expected = internalDates.Select(i => (Date)dateType.FromInternal(i)).ToArray();
    ...
    {
      {
        ...
        Dictionary<int, int> dict = Enumerable.Range(0, 10).ToDictionary(i => i, i => i * i);
      ...
      }
      {
        ...
        var actual = (Hashtable)
          mapType.FromInternal(new Hashtable(internalDates.ToDictionary(i => i, i => i)));
