...
namespace Flowthru.Tests.Spark
{
    public class UdfWrapperTests
    {
        ...
        {
            var udfWrapper = new PicklingUdfWrapper<string, string>((str1) => str1);
        ...
        {
            var udfWrapper = new PicklingUdfWrapper<string, string, string>((str1, str2) => str1 + str2);
        ...
        public void TestPicklingUdfWrapper6()
        {
            var udfWrapper = new PicklingUdfWrapper<
              ...
              string,
              string
            >((str1, str2, str3, str4, str5, str6) => str1 + str2 + str3 + str4 + str5 + str6);
        ...
        {
            var udfWrapper = new ArrowUdfWrapper<StringArray, StringArray>((str1) => str1);
        ...
        public void TestArrowUdfWrapper6()
        {
            var udfWrapper = new ArrowUdfWrapper<
              ...
              StringArray,
              StringArray
            >((str1, str2, str3, str4, str5, str6) => Concat(str1, str2, str3, str4, str5, str6));
