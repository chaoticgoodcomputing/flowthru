...
The directory already exists. To add a new ADR, scan it for the highest existing number and increment by one.
...
- **Project-vocabulary choices.** When a term has multiple synonymous spellings (compile-time / build-time / design-time) and you pick one as canonical, an ADR records why — see `0002-design-time-canonical-phase-1.md` for an example.
